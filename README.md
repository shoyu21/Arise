...
[![Version](https://img.shields.io/badge/version-3.7.0-teal.svg)](https://github.com/shoyu21/ARISE)
...
- Align with MICU protocols (dated June 2025)
...
ARISE integrates evidence from peer-reviewed literature including:
- Systematic reviews and meta-analyses on extubation failure predictors
- Validated risk scoring systems (APACHE II, RSBI, ExPreS, RISC)
- International guidelines on ICU liberation protocols
- Population-specific studies (COPD, Heart Failure, Obesity, Elderly)

All evidence citations are provided within the tool's tooltips.
...
|---------|------|---------|
| 3.7.0 | Dec 2024 | Live-updating conclusion bars, APACHE II streamlining, UTF-8 encoding fixes, post-SBT enhancements |
...
Clinical Decision Support Tool, Version 3.7.0
